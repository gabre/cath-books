...
class PpekBookSpec extends AnyFlatSpec with Matchers with IdiomaticMockito {
  ...
  "PpekBook" should "parse author and title correctly" in {
    val link = mockElement("1940. november 24-re elrendelt engesztelés imádságai; XII. Pius pápa")
    val result = PpekBook.parseAuthorAndTitle(link)
    result shouldBe Right(("XII. Pius pápa", "1940. november 24-re elrendelt engesztelés imádságai"))
  }
  ...
  def mockElement(text: String, attrs: Map[String, String] = Map("href" -> "some-href")) = {
